            ...
            {stage === "card" && (
              <form onSubmit={handleCardSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input 
                        ...
                        maxLength={19} 
                        className="w-full p-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#8A1538]/20 focus:border-[#8A1538] outline-none font-mono text-lg transition-all" 
                        placeholder="0000 0000 0000 0000" 
                        required 
                      />
                      <div className={`absolute inset-y-0 ${isAr ? "left-4" : "right-4"} flex items-center`}>
                        {cardType === "visa" && <img src="/visa-logo.png" alt="Visa" className="h-5 animate-in fade-in duration-300" />}
                        {cardType === "mastercard" && <img src="/mastercard-logo.png" alt="Mastercard" className="h-8 animate-in fade-in duration-300" />}
                        {cardType === "unknown" && (
                          <div className="flex gap-1 opacity-30 grayscale">
                            <img src="/visa-logo.png" alt="Visa" className="h-4" />
                ...
                <button 
                  ...
                  className="w-full bg-[#8A1538] text-white py-5 rounded-xl font-black text-lg hover:bg-[#70112d] transition-all shadow-lg active:scale-[0.98] disabled:opacity-50 mt-4"
                >
