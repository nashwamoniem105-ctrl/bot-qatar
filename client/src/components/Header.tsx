...
export function Header() {
  ...
  return (
    <header className="bg-white border-b border-gray-100 w-full sticky top-0 z-50 shadow-sm overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between gap-4" dir={isAr ? "rtl" : "ltr"}>
        {/* Official MOI Logo */}
        ...
        {/* Vertical Divider */}
        <div className="h-14 sm:h-16 w-[2px] bg-[#8A1538] flex-shrink-0"></div>
        
        {/* Payment Gateway Text */}
        <div className={`flex flex-col ${isAr ? "items-end" : "items-start"} flex-grow`}>
          <span className="text-lg sm:text-2xl font-black text-[#8A1538] leading-tight">
      ...
      <div className="bg-white border-y border-gray-100 w-full py-1.5">
        <div className="max-w-6xl mx-auto px-4 flex justify-between items-center" dir={isAr ? "rtl" : "ltr"}>
          ...
          >
            ...
            <span className="bg-[#003E66] text-white px-1 rounded text-[8px] font-black">A文</span>
          </button>
